...
#ルールを記録する
[suzuki@suzuki-t ~]$ cp /etc/sysconfig/iptables /etc/sysconfig/iptables.bak
cp: `/etc/sysconfig/iptables' を 読み込み用に開くことが出来ません: 許可がありません
[suzuki@suzuki-t ~]$ sudo cp /etc/sysconfig/iptables /etc/sysconfig/iptables.bak
[suzuki@suzuki-t ~]$ /usr/libexec/iptables/iptables.init save
iptables: Only usable by root.                             [警告]
[suzuki@suzuki-t ~]$ sudo /usr/libexec/iptables/iptables.init save
iptables: Saving firewall rules to /etc/sysconfig/iptables:[  OK  ]
[suzuki@suzuki-t ~]$ diff /etc/sysconfig/iptables /etc/sysconfig/iptables.bak
diff: /etc/sysconfig/iptables: 許可がありません
diff: /etc/sysconfig/iptables.bak: 許可がありません
[suzuki@suzuki-t ~]$ sudo diff /etc/sysconfig/iptables /etc/sysconfig/iptables.bak
1c1,3
< # Generated by iptables-save v1.4.21 on Fri Nov 19 18:49:25 2021
---
> # sample configuration for iptables service
> # you can edit this manually or use system-config-firewall
> # please do not ask us to add additional ports/services to this default configuration
5c7
< :OUTPUT ACCEPT [42:6292]
---
> :OUTPUT ACCEPT [0:0]
10,13d11
...
17d14
< # Completed on Fri Nov 19 18:49:25 2021
